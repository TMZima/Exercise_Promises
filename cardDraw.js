...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Maybe add the part one and two to this. Also add try/catch.
  async function setup() {
    ...
    btn.addEventListener("click", async function () {
      ...
      // Create an image element and append it to the card area.
      let img = document.createElement("img");
      // Set the image source and style properties.
      img.src = cardSrc;
